...
def test_main_no_diff(mocker):
    ...
    mocker.patch.object(helper, 'run_tests')
    mocker.patch.object(helper, 'check_coverage')
    mocker.patch.object(helper, 'generate_commit_message')
    mocker.patch.object(helper, 'prompt_for_confirmation')
