...
class GitCommitHelper:
    ...
    def main():
        try:
            ...
            extra_context = input("Provide any additional context for the commit message (optional): ")
            ...
            while True:
                ...
                if action == 'y':
                    ...
                    extra_context = input(f"Edit the context for the commit message (current context: {extra_context}): ")
                else:
